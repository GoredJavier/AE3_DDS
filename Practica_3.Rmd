...
dt <- read.csv2("https://raw.githubusercontent.com/GoredJavier/DataDrivenSecurity/refs/heads/main/epa-http.csv", sep=' ', header=FALSE)
...
dt <- separate(dt, Protocol, into = c("Protocol", "Resource", "Version"), sep = " ")
